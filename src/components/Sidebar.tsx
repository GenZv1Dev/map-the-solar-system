  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 p-2 bg-gray-900/90 rounded-lg border border-gray-700 hover:bg-gray-800 transition-colors"
      >
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 h-full bg-gray-900/95 backdrop-blur-sm border-r border-gray-700 transition-all duration-300 z-40 ${
          ...
          <div className="flex border-b border-gray-700">
            <button
              ...
              className={`flex-1 py-3 text-sm font-medium transition-colors ${
                activeTab === 'nav' ? 'text-cyan-400 border-b-2 border-cyan-400' : 'text-gray-400 hover:text-white'
              }`}
            >
              Navigate
            </button>
            <button
              ...
              className={`flex-1 py-3 text-sm font-medium transition-colors ${
                activeTab === 'asteroids' ? 'text-cyan-400 border-b-2 border-cyan-400' : 'text-gray-400 hover:text-white'
              }`}
            >
              Asteroids
            </button>
            <button
              ...
              className={`flex-1 py-3 text-sm font-medium transition-colors ${
                activeTab === 'stats' ? 'text-cyan-400 border-b-2 border-cyan-400' : 'text-gray-400 hover:text-white'
              }`}
            >
              Stats
            </button>
